    ...
    <Layout title="Home" description="Basic Formal Ontology (BFO)">
      <main className="container padding-vert--lg">
        <div className="page-index-wrapper">
          ...
          <p>
            Since then, major contributions to BFO have been made by many, including:
          </p>
          ...
          >
            ...
            <div><a href="https://www.linkedin.com/in/alanruttenberg">Alan Ruttenberg</a></div>
          ...
          >
            ...
            <a href="https://www.youtube.com/channel/UC8rDbmRGP6A2bs6tn0AOErQ" target="_blank" rel="noopener noreferrer">
              BFO YouTube Channel
            </a>
